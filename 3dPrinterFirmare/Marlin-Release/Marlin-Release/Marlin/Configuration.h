...
#define TEMP_SENSOR_BED 1 //My thermister is #6
...
// Ultimaker
    ...
    #define  DEFAULT_Ki .84
    #define  DEFAULT_Kd 106.24
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,2560,500}  // default steps per unit for Ultimaker
